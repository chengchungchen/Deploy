...
sed -i 's/;emergency_restart_threshold = 0/emergency_restart_threshold = 10/g' /opt/rh/php55/root/etc/php-fpm.conf
sed -i 's/;emergency_restart_interval = 0/emergency_restart_interval = 1m/g' /opt/rh/php55/root/etc/php-fpm.conf
sed -i 's/;process_control_timeout = 0/process_control_timeout = 10s/g' /opt/rh/php55/root/etc/php-fpm.conf
